...
make_top_up_operation_response = operations_gateway_client.make_top_up_operation(account_id=open_credit_card_account_response.account.id, card_id=open_credit_card_account_response.account.cards[0].id)
