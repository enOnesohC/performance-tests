...
from contracts.services.gateway.operations.rpc_get_operation_receipt_pb2 import (
    GetOperationReceiptResponse, GetOperationReceiptRequest
)
...
# Создаём gRPC-клиент для UsersGatewayService, AccountsGatewayService, OperationsGatewayService
...
create_open_debit_card_account = OpenDebitCardAccountRequest(
